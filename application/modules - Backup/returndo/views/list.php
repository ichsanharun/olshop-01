          ...
          <?php if(@$results){ ?>
            ...
            <tr>
              ...
              <td class="text-center">
                    ...
                    <?php }else{ ?>
                    <button type="button" class="btn btn-sm btn-warning" id="btn_sdh<?php echo $no?>" onmouseover="omover(<?php echo $no?>)" onmouseout="omout(<?php echo $no?>)" onclick="viewkonfirmdo('<?php echo $vso->no_do?>')">
