                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                ?>
                                <option value="<?php echo $vc->id_supplier; ?>" <?php echo set_select('idsupplier', $vc->id_supplier, isset($data->nm_supplier) && $data->id_supplier == $vc->id_supplier) ?> <?php echo $selected?>>
