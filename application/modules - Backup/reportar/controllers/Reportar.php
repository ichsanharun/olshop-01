    ...
    */
    ...
    public function index()
    {
        ...
        */
        ...
        $data = array();
        $cabang = $this->Cabang_model->order_by('kdcab','ASC')->find_all();
        $this->template->title('Report Piutang Bulanan');
        $this->template->set('cabang', $cabang);
        $this->template->set('results', $data);
     ...
     function downloadExcel()
    {
        ...
        $objPHPExcel->getProperties()->setCreator("Importa")
            ...
            ->setTitle("Export Laporan Piutang Bulanan")
            ->setSubject("Export Laporan Piutang Bulanan")
            ->setDescription("Laporan Piutang Bulanan for Office 2007 XLSX, generated by PHPExcel.")
            ->setKeywords("office 2007 openxml php")
            ->setCategory("PHPExcel");
        $objPHPExcel->getActiveSheet()->setTitle('Laporan Piutang Bulanan');
        ob_end_clean();
