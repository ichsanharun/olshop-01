            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_adjusment','name'=>'frm_adjusment','role'=>'form','class'=>'form-horizontal')) ?>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="hidden" class="form-control" id="qty_stock" name="qty_stock" value="<?php echo set_value('qty_stock', isset($data->qty_stock) ? $data->qty_stock : ''); ?>" onkeyup="this.value=this.value.replace(/[^0-9\.]/g,'');">
                        <input type="hidden" class="form-control" id="qty_avl" name="qty_avl" value="<?php echo set_value('qty_avl', isset($data->qty_avl) ? $data->qty_avl : ''); ?>" onkeyup="this.value=this.value.replace(/[^0-9\.]/g,'');">
                        </div>
                    </div>
