    ...
    <div class="form-group row">
        ...
        <div class="col-sm-5 pull-right">
            <div class="input-group">
                ...
                <input type="text" name="persen_fiskal" id="persen_fiskal" class="form-control input-sm" value="" onkeyup="filterAngka1(this.id)" maxlength="3">
            </div>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <center>
                          <div class="input-group">
                            <input type="text" name="qty_supply[]" id="qty_supply_<?php echo $no?>" style="width:100%;" class="form-control input-sm supply">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //$('#in_fiskal_total').text(0);
        //$('#in_non_fiskal_total').text(0);
        //$('#in_harga_total').text(0);
        //$('#in_supply_total').text(0);
        //$('#in_harga_beli_total').text(0);
        ...
        $('.supply,.harga_beli,#persen_fiskal').on('keyup', function(){
          ...
          for (var i = 0; i < jum; i++) {
            ...
            var j = parseInt(i)+1;
            var confirm_id = parseInt($('#qtyconfirm_'+j).val());
            var supply_id = parseInt($('#qty_supply_'+j).val());
            //alert(supply_id);
            if(supply_id > confirm_id){
                swal({
                    title: "Peringatan!",
                ...
                $('#qty_supply_'+j).val($('#qty_pr_'+j).text());
            }
