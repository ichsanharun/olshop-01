...
<body>
    <div id="wrapper">
      <table width="100%" border="0" id="header-tabel" style="font-size:14pt">
        <tr>
      ...
      <table width="100%" id="tabel-laporan" style="font-size:14pt">
          <tr>
              <th width="2%">NO</th>
  ...
  <div class="footer">
    <hr>
    <table width="100%" border="0" style="font-size: 18pt" id="table-footer">
        <tr>
            <td colspan="4">
                Keterangan :<br>
