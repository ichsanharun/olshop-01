  ...
  <div class="box-body">
    <table id="example1" class="table table-bordered table-striped">
        ...
        foreach(@$results as $kr=>$vr){
          $no = $n++;
          //$hpp = $vr->hargajualbefdis;
          $hpp = $vr->hargalandedtotal;
          $omset = $vr->hargajualtotal;
          $laba = $omset-$hpp;
        ...
        <tr>
          ...
          <td class="text-right"><?php echo formatnomor($hpp)?></td>
          <td class="text-right"><?php echo formatnomor($omset)?></td>
          <td class="text-right"><?php echo formatnomor($laba)?></td>
          <td class="text-right"><?php echo $margin?></td>
        </tr>
        <?php } ?>
        <?php } ?>
        </tbody>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#submit").on('click', function(){
      ...
      window.location.href = siteurl+"reportpenjualan/filter/"+pawal+"/"+pakhir+"/"+cabang;
    });
  });
