     ...
     function downloadExcel()
    {
		...
		*/
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('A2', 'Periode :'.date('d M Y',strtotime($this->input->get('tglawal'))).' s/d '.date('d M Y',strtotime($this->input->get('tglakhir'))))
            ->setCellValue('A3', 'No.')
        ...
        header('Content-Disposition: attachment;filename="LaporanPenjualan'.$this->input->get('tglawal').'sd'.$this->input->get('tglakhir').'.xls"');
