...
<div id="wrapper">
    <table width="100%" border="0" id="header-tabel">
        <tr>
            <th colspan="7  " width="20%" style="text-align: center;font-size: 18px;">PICKING LIST (PL)<br>No. :<?php echo $so_data->no_picking_list."WD"?></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="1%">:</td>
            <td colspan="5"><?php echo strtoupper(@$so_data->nm_customer)?></td>
        </tr>
         <tr>
    ...
    <table width="100%" id="tabel-laporan">
        ...
        <tr>
            ...
            <td width="5%" rowspan="<?php echo $rs?>" valign="middle"><center><?php echo $vs->qty_booked-$vs->qty_supply?></center></td>
